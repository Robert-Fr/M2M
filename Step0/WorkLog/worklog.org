...
Je pense que cela vient du fait que les librairies que j'ai mis sous /lib 
ne sont pas contenue dans initrd.hello (pour cela il faudrait modifier le makefile pour qu'il ne contienne pas que le programme hello mais aussi les librairies dont le programem a besoin ?
