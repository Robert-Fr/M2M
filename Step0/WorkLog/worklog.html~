...
<li><a href="#sec-8-4">8.4. What is the special testing of the value 13 as a special character and why</a></li>
<li><a href="#sec-8-5">8.5. Why can we say this program polls the serial line? Although it works,</a></li>
...
<h3 id="sec-8-4"><span class="section-number-3">8.4</span> What is the special testing of the value 13 as a special character and why</h3>
...
<h3 id="sec-8-5"><span class="section-number-3">8.5</span> Why can we say this program polls the serial line? Although it works,</h3>
...
<p class="date">Created: 2021-02-07 Sun 17:23</p>
